...
int GetValue(int k, int l) {
    ...
    // 連三
        ...
        if(board[k][flag_left - 2] == player && board[k][flag_left - 1] == 0 && board[k][flag_right + 1] == 0 && board[k][flag_right + 2] == player) {
            SumValue += 2;   // X.XXX.X
        }
    ...
    // 連三
        ...
        if(board[flag_up - 2][l] == player && board[flag_up - 1][l] == 0 && board[flag_down + 1][l] == 0 && board[flag_down + 2][l] == player) {
            SumValue += 2;   // X.XXX.X
        }

    ...
    // }
        ...
        if(flag_up == k) {
            if(flag_down + 1 == SIZE) {
                ...
                if(board[flag_up - 1][l] == player) {
                    SumValue += NO_D4;  // X.OOO.#
                }
                else if(board[flag_up - 1][l] == 0) {
                    SumValue += NO_D3;  // ..OOO.#
                }
            }
            else {
                if(board[flag_up - 1][l] == player && board[flag_down + 2][l] == player) {
                    SumValue += NO_D4;  // X.OOO.X
                }
                if(board[flag_down + 1][l] == 0 && board[flag_down + 2][l] == 0) {
                    SumValue += NO_D2;  // XOOO..
            ...
            if(flag_up == 0) {
                ...
                if(board[flag_up - 1][l] == 0 && board[flag_up - 2][l] == 0) {
                    SumValue += NO_D2;  // ..OOOX
                }
                if(board[flag_up - 2][l] == player && board[flag_down + 1][l] == player) {
                    SumValue += NO_D4;  // X.OOO.X
                }
            }
        }
            ...
            if(flag_up == 0) {
                ...
                if(board[flag_up - 1][l] == 0 && board[flag_down + 1][l] == 0) {
                    SumValue += NO_D2;
                }
            }
        }
...
// tuple<int, int, int> alphabeta(Node *nd, int depth, int Alpha, int Beta, bool now_player) {
//     tuple<int, int, int>cur;
//     find_nextstep(nd);
//     if(depth == 0 || nd->child.empty()) {
//         nd->value = GetValue(nd->x, nd->y);
...
//         for(auto k : nd->child) {
//             board[k->x][k->y] = player;
//             cur = alphabeta(k, depth - 1, Alpha, Beta, false);
//             board[k->x][k->y] = 0;
...
//         for(auto k : nd->child) {
//             board[k->x][k->y] = 3 - player;
//             cur = alphabeta(k, depth - 1, Alpha, Beta, true);
//             board[k->x][k->y] = 0;
